...
final class TimerViewUITests: XCTestCase {
  ...
  @MainActor
  func testTimerStartAndStop() throws {
  ...
  @MainActor
  func testTimerControlsAccessibility() throws {
    let playPauseButton = app.buttons.matching(identifier: "timer.play.pause").firstMatch
  ...
  @MainActor
  func testPreferredTimeDisplayExists() throws {
  ...
  @MainActor
  func testPreferredTimeDisplayFormat() throws {
  ...
  @MainActor
  func testActivePlayersSectionExists() throws {
  ...
  @MainActor
  func testBenchSectionExists() throws {
  ...
  @MainActor
  func testTemporarilyOutSectionExists() throws {
  ...
  @MainActor
  func testPlayerRowsDisplayed() throws {
  ...
  @MainActor
  func testSubstitutionButtonExists() throws {
  ...
  @MainActor
  func testSubstitutionButtonTap() throws {
    let subButton = app.buttons["Substitute"]
  ...
  @MainActor
  func testManualSubstitutionButton() throws {
  ...
  @MainActor
  func testPlayerRowTapShowsActionSheet() throws {
  ...
  @MainActor
  func testBenchPlayerFromActionSheet() throws {
  ...
  @MainActor
  func testActivatePlayerFromBench() throws {
  ...
  @MainActor
  func testTemporarilyOutPlayer() throws {
  ...
  @MainActor
  func testManualSubstitutionFlow() throws {
  ...
  @MainActor
  func testTimerUpdatesWhileRunning() throws {
    // Start timer
    let playPauseButton = app.buttons.matching(identifier: "timer.play.pause").firstMatch
  ...
  @MainActor
  func testEmptyBenchSection() throws {
  ...
  @MainActor
  func testMultipleSubstitutions() throws {
    let substituteButton = app.buttons["Substitute"]
  ...
  @MainActor
  func testCompleteTimerSession() throws {
    // Start timer
    let playPauseButton = app.buttons.matching(identifier: "timer.play.pause").firstMatch
    if playPauseButton.exists {
      playPauseButton.tap()
